 ...
 <div className={classes.payment_method}>
     ...
     <label>
         ...
         <strong >Card Number</strong><br></br>
          ...
          <strong >Expiry Date</strong><br></br>
          <select>
              <option>MM</option>
          ...
          <input style={{width:"18%",height:"auto"}} type="password" placeholder='CVV' maxlength="3"></input><br></br>
         
        <div className={classes.payment_method4}>
        <input style={{width:"20px"}} type="checkbox"></input>
        <span style={{marginLeft:"10px" }}>Save this card for a faster checkout experience</span>
        </div><br></br>
        <strong>Billing address</strong><br></br>
        <div className={classes.payment_method4}>
        <input style={{width:"20px"}} type="checkbox"></input>
        <span style={{marginLeft:"10px" }}> Is billing address the same as shipping address?</span>
        </div>
         </form>
         </div>
     </label>
