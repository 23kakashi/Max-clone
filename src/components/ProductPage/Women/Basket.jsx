...
<p onClick={()=>handleRemove(item.id)}>Remove</p>
        ...
        <div className='basketMainRight'>
            ...
            <p style={{backgroundColor:"linen",fontSize:"14px" ,padding:"10px"}}>Enter pin code in box above for delivery estimates and charges</p>
            </div>
            <div className='basketDiv2'>
            <div>
                <img src='https://www.maxfashion.in/static/icons/gift-box.png' alt="Error loading pic"/>
            </div>
            <div>
            ...
            <p style={{color:"gray"}}>Choose and apply voucher in 2 simple steps</p>
            </div>
            </div>
            ...
            <div className='basketDiv4'>
                ...
                <p style={{fontSize:"14px",color:"gray"}}>Tap here to log in and enrol for Landmark Rewards. Earn with every purchase and redeem for discounts.</p>
                <p style={{color:"rgb(48,58,178)"}}> <u>Learn more</u></p>
            </div>
